...
function createBook(speed){
var i = 0;
var txt = "It was then that the fox appeared. ~\
...
function moveUp(){
    var currentTop = parseInt(book.style.marginTop, 10);
    book.style.marginTop = (currentTop - 12) + "px";
}
